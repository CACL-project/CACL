...
from demo_app.routes.users import router as users_router
from demo_app.core.settings import settings as app_settings
...
def validate_auth_mode_consistency():
    ...
    if app_mode != lib_mode:
        raise RuntimeError(
            ...
            f"  demo_app.settings.USE_COOKIE_AUTH = {app_mode}\n"
